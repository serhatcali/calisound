...
import type { ReleaseTemplate, ReleasePlatform } from '@/types/release-planning'
...
export function EditTemplateForm({ template: initialTemplate }: EditTemplateFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    default_city: initialTemplate.default_city || '',
    default_country: initialTemplate.default_country || '',
    default_local_language: initialTemplate.default_local_language,
    default_local_language_code: initialTemplate.default_local_language_code,
    default_include_english: initialTemplate.default_include_english,
    default_timezone: initialTemplate.default_timezone,
    default_fast_mode: initialTemplate.default_fast_mode,
    default_platforms: initialTemplate.default_platforms,
    tags: initialTemplate.tags || [],
    is_public: initialTemplate.is_public,
  })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/admin/templates/${initialTemplate.id}`, {
        method: 'PATCH',
