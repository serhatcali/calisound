...
export function CopyTools({ city }: CopyToolsProps) {
  ...
  return (
    <div className="bg-white dark:bg-black rounded-2xl p-8 border border-gray-100 dark:border-gray-900">
      <h2 className="text-2xl font-bold text-white mb-6">Copy Tools</h2>
      
      <div className="space-y-4">
        {/* YouTube Title */}
        {city.yt_title && (
          <div className="bg-white dark:bg-black rounded-xl p-6 border border-gray-100 dark:border-gray-800 overflow-hidden">
            <div className="flex items-center justify-between mb-3 gap-4">
              <h3 className="font-semibold text-white flex-shrink-0">YouTube Title</h3>
              <button
              ...
              <p className="text-white dark:text-gray-300 break-words overflow-wrap-anywhere">{city.yt_title}</p>
          </div>
        )}
        ...
        {city.yt_description && (
          <div className="bg-white dark:bg-black rounded-xl p-6 border border-gray-100 dark:border-gray-800 overflow-hidden">
            <div className="flex items-center justify-between mb-3 gap-4">
              <h3 className="font-semibold text-white flex-shrink-0">YouTube Description</h3>
              <button
            ...
            <p className="text-white dark:text-gray-300 whitespace-pre-line text-sm break-words overflow-wrap-anywhere max-w-full">{city.yt_description}</p>
          </div>
        )}
          ...
          <div className="bg-white dark:bg-black rounded-xl p-6 border border-gray-100 dark:border-gray-800 overflow-hidden">
            <div className="flex items-center justify-between mb-3 gap-4">
              <div className="min-w-0 flex-1">
                <h3 className="font-semibold text-white">YouTube Tags</h3>
            ...
            <p className="text-white dark:text-gray-300 text-sm break-words overflow-wrap-anywhere max-w-full">{city.yt_tags}</p>
          </div>
        )}
        ...
        {city.hashtags && (
          <div className="bg-white dark:bg-black rounded-xl p-6 border border-gray-100 dark:border-gray-800 overflow-hidden">
            <div className="flex items-center justify-between mb-3 gap-4">
              <h3 className="font-semibold text-white flex-shrink-0">Hashtags</h3>
              <button
            ...
            <p className="text-white dark:text-gray-300 text-sm break-words overflow-wrap-anywhere max-w-full">{city.hashtags}</p>
          </div>
        )}
      </div>
    </div>
