...
export function MaleIcon({ className = '', size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M10 14a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z" />
      <path d="M21 3-6 6" />
      <path d="M17 3h4v4" />
    </svg>
  )
...
export function FemaleIcon({ className = '', size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function OnlineIcon({ className = '', size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
